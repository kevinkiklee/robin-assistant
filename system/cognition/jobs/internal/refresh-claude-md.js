// refresh-claude-md.js — hourly regen of <packageRoot>/CLAUDE.local.md and
// GEMINI.local.md so persona / jobs / integration changes reach agent
// sessions without requiring a manual `robin mcp install`. Workspace-scoped
// (gitignored) so the global ~/.claude/CLAUDE.md stays clean across projects.
//
...
// those updates only appeared in CLAUDE.local.md when a human reinstalled
// the MCP.
