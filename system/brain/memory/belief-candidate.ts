...
// `isLowQualityClaim` lives in its own module so `belief.ts` can also enforce it
// without a circular import (belief-candidate → belief → belief-candidate).
