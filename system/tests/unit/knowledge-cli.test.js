...
const { ingestCmd } = await import('../../runtime/cli/commands/ingest.js');
const { lintCmd } = await import('../../runtime/cli/commands/lint.js');
const { auditCmd } = await import('../../runtime/cli/commands/audit.js');
