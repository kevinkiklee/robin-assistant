...
//
// Prerequisite: in user-data/runtime/secrets/.env, set:
...
async function main() {
  ...
  try {
    ...
    console.error(
      ...
      'Then add this line to user-data/runtime/secrets/.env:\n' +
  ...
  console.log('    node user-data/runtime/scripts/sync-github.js --bootstrap');
}
