...
| self-improvement/calibration.md | Calibration log — Robin's track record on confidence-tagged claims. |
| self-improvement/communication-style.md | How the user prefers Robin to communicate — base style and domain overrides. Base seeds align with CLAUDE.md "Conversational tics" rule. |
