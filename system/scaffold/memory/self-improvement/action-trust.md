...
Calibration evidence per action class. Source of truth; the compact-summary block in `user-data/runtime/config/policies.md` is the derived view loaded at session start.
