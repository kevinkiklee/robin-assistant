...
//
// loadManifest      — read user-data/runtime/security/manifest.json. Auto-creates
...
const MANIFEST_REL = 'user-data/runtime/security/manifest.json';
const SCAFFOLD_REL = 'system/scaffold/runtime/security/manifest.json';
