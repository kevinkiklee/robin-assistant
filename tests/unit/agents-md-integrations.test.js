...
test('agentsMdContent renders 1-day cadence as 1d', () => {
  const md = agentsMdContent({
    integrations: [
      { name: 'lunch_money', cadence_ms: 86_400_000, tool_names: ['lunch_money_query'] },
    ],
  });
...
test('agentsMdContent renders hour cadence', () => {
  const md = agentsMdContent({
    integrations: [{ name: 'foo', cadence_ms: 3_600_000, tool_names: ['foo_tool'] }],
  });
...
test('agentsMdContent renders integration with empty tool_names as no-tools line', () => {
  const md = agentsMdContent({
    integrations: [{ name: 'silentsync', cadence_ms: 900_000, tool_names: [] }],
  });
