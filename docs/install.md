...
4. **Runs migrations** (`runMigrations`) against `<robinHome>/data/db/` — applies any pending `.surql` files, including the profile-specific `0002-embeddings-<profile>.surql` (one of `mxbai-1024`, `qwen3-4096`, `gemini-3072`).
