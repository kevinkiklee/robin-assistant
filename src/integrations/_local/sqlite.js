 ...
 * etc.). Copies the source file to a temp location, opens it read-only,
 * invokes the caller's queryFn, then deletes the snapshot. SurrealDB remains
 * the sole datastore; better-sqlite3 is used here purely as a transient
 * client lib for vendor-shaped local SQLite files.
 *
 * @param {object} args
