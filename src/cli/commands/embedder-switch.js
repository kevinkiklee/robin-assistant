...
export async function embedderSwitch(argv, options = {}) {
  ...
  try {
    ...
    //   - knowledge/entities/recall_events are derived data — regenerated by
    ...
    await db.query('DELETE recall_events').collect();
    ...
    console.log(
      `switched from ${current} to ${target}; re-embedded ${reembedded} events. knowledge/entities/recall_events were cleared and will regenerate from raw events.`,
    );
  } catch (e) {
